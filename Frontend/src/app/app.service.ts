...
export class AppService {
  ...
  dailyform(user){
    return this.http.post(this.url+'/calldaily',user)
  }
  renewalform(user){
    return this.http.post(this.url+'/callrenewal',user)
  }
  mainlink(user){
    return this.http.get(this.url+'/mainlink/'+user);
  }
  getadministrator(){
    return this.http.get(this.url+'/administrator');
  }
  getUser()
  {
  ...
  updatemaincountdec(user){
    return this.http.get(this.url+'/mainlink/countdec/'+user);
  }
